                            ...
                            <div class="col-sm-10">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div>
                                         ...
                                         <input type="file" id="userimage" class="default" name="User[image]" />
                                ...
                                <?=  Html::submitButton($model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), ['class' =>'btn btn-primary load-button submit']) ?>
